...
| | |
|---|---|
| **Dataset** | 1,800+ political content items, 30–45 influencers |
| **Methods** | Social network analysis · multilingual NLP · multilevel regression |
| **Tools** | NetworkX · mBERT / XLM-R · LIWC-22 · R / lme4 |
...
`Multilingual NLP` · `Cross-lingual transfer` · `Political influencers` · `Algorithmic fairness` · `Digital governance` · `Small-state politics` · `Computational social science` · `Responsible AI`
